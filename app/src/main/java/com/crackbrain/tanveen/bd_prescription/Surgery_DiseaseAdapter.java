 ...
 */
public class Surgery_DiseaseAdapter extends BaseExpandableListAdapter
{
    private Context ctx ;
    private List<String> diseaseList;
    private HashMap<String, List<String>> diseaseCategory;

    public Surgery_DiseaseAdapter(Context ctx, HashMap<String, List<String>> diseaseCategory, List<String> diseaseList)
    {
        this.ctx = ctx;
    ...
    public View getGroupView(int parent, boolean isExpanded, View convertView, ViewGroup parentView) {
        ...
        if(convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.surgery_parent_layout,parentView,false);
        }
...
*/
    ...
    public View getChildView(int parent, int child, boolean lastChild, View convertView, ViewGroup parentView)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.surgery_child_layout,parentView,false);
